// Interrupt driven serial functions for DS89C440 MCU.
...
//////////////////////////////////////// Serial 0 /////////////////////////////////////
#define RBUFSIZE0 128							         // size of the receive buffer in bytes
...
__xdata volatile unsigned char rx0_buf[RBUFSIZE0]; // receive buffer for serial 0 in internal MOVX RAM
volatile __bit tx0_ready;
...
volatile unsigned char rx1_head;       	         // receive interrupt index for serial 1
volatile unsigned char rx1_tail;       	         // receive read index for serial 1
__xdata volatile unsigned int rx1_buf[RBUFSIZE1];  // receive buffer for serial 1 in internal MOVX RAM
volatile __bit tx1_ready;                          // set when ready to transmit
__sbit __at (0x92) WWbus;		  			            // P1.2, (RXD1, pin 3) used to monitor the Wheelwriter BUS
volatile __bit waitingForAcknowledge = 0;          // TRUE when expecting the acknowledge pulse from Wheelwriter
